...
int main (int argc, char *argv[]) 
{
	...
	if (argc<2){
  	...
  	sockfd = socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);   // create a socket this returns 0 is successful else SOCKET_ERROR
 	...
 	int binded = bind(sockfd, (sockaddr *)&serv_addr, sizeof(serv_addr));
 	if (binded <0 ) {
